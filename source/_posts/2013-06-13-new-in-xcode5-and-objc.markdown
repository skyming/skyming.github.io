...
![Xcode5减小了顶栏宽度](http://img.onevcat.com/2013/xcode5-header.png)

首先值得称赞的是顶部工具栏的变化，新版中贯彻了精简的原则，将顶栏砍掉了30%左右的宽度，对于小屏幕来说绝对是福音。另外，在外观上界面也向平面和简洁的方向迈进了一大步，可算是对iOS7的遥相呼应吧。

### 更易用的版本管理

![image](http://img.onevcat.com/2013/xcode5-sourcecontrol.png)
...
![Xcode5的Capabilities](http://img.onevcat.com/2013/xcode5-capabilities.png)
...
![添加一个Asset Catalog](http://img.onevcat.com/2013/xcode5-asset-catalog.png)
...
![在Asset Catalog中添加图片](http://img.onevcat.com/2013/xcode5-add-ac.png)
...
![设定Image Slicing](http://img.onevcat.com/2013/xcode5-slicing.png)

在左侧线（或者上方线）和中间线之间的像素将在缩放时被填充，在中间线和右侧线（或者下方线）之间的像素将被隐藏。比如上面的例子，实际运行中如果对这张图片进行拉伸的话，会是下面的样子：

![拉升Image Slicing后的图片](http://img.onevcat.com/2013/xcode5-slicing-image.png)
...
![鼠标悬浮就可以出现变量结果](http://img.onevcat.com/2013/xcode5-debug-mouseover.png)
...
![直接悬停显示图片](http://img.onevcat.com/2013/xcode5-debug-image.png)
...
![Debug的Profiler面板](http://img.onevcat.com/2013/xcode5-debug-profiler.png)
...
![Xcode对代码注释的解析](http://img.onevcat.com/2013/xcode5-comment-doc.png)

以及Quick Help中会有详细信息

![在Quick Help中显示详细文档](http://img.onevcat.com/2013/xcode5-quickhelp.png)
